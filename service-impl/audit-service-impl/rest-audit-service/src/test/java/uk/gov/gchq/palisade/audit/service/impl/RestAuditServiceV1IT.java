...
//import uk.gov.gchq.palisade.policy.service.impl.MockPolicyService;
...
public class RestAuditServiceV1IT {
    ...
    private static ProxyRestAuditService proxy;
    private static EmbeddedHttpServer server;


    @BeforeClass
    public static void beforeClass() throws IOException {
        RestAuditServiceV1.setDefaultDelegate(new MockAuditService());
        proxy = (ProxyRestAuditService) new ProxyRestAuditService("http://localhost:8081/policy").retryMax(1);
